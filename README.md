...
T-thinkerQ utilizes a novel active task-queue list to ensure the fairness that queries are answered in the received order: a later query is processed only if earlier queries cannot saturate the available computation resources. 
...
<p align="center">
  <!-- <img src="imgs/Lineage_Tracking.png" width="450" height="300" /> -->
  <img align="center" src="https://github.com/guimuguo/TthinkerQ/blob/main/img/Lineage_Tracking.png" width="450" height="300" />
</p>
