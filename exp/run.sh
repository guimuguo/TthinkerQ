home_path="/home/lyuan/vldbj2021/Tthinker"
monitor_path=$home_path/monitor
app_qc_path=$home_path/app_qc
...
p1_arr["GSE1730_q"]="30;0.8"
p1_arr["GSE10158_q"]="29;0.74"
...
(date;time $app_qc_path/run /home/lyuan/graph_data/${f} ${compers} ${gamma} ${t_size} ${tau_time} ${tau_split};date) 2>&1 | tee ${log};
